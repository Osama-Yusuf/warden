...
const ICONS = {
  ...
  assistant: I('<path d="M12 3l1.7 4.3L18 9l-4.3 1.7L12 15l-1.7-4.3L6 9l4.3-1.7z"/><path d="M18.6 14.6l.8 2 2 .8-2 .8-.8 2-.8-2-2-.8 2-.8z"/>'),
...
function navModel() {
  ...
  if (fam === 'sqlite') {
    return [
      ...
      { id: 'assistant', icon: ICONS.assistant, label: 'Assistant', always: true },
    ];
  }
  return [
